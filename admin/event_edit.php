                    ...
                    <form action="event_update.php" method="POST" enctype="multipart/form-data">
                            ...
                            <?php if (!empty($event['documentation'])): ?>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox"
                                           name="delete_documentation" id="delete_documentation" value="1">
                                    <label class="form-check-label" for="delete_documentation">
                                        Hapus gambar ini
                                    </label>
                                </div>
                            <?php else: ?>
                        ...
                        <div class="mb-3">
                            <label for="documentation" class="form-label">
                                Upload Dokumentasi Baru <span class="text-muted">(opsional)</span>
                            </label>
                        ...
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control form-control-lg"
                                       ...
                                       value="<?php echo $event['quota']; ?>" required>
                            </div>
                        </div>
                                ...
                                <select class="form-select form-select-lg" id="category" name="category" required>
                                    ...
                                    <?php foreach (['Seminar','Workshop','Lomba','Sosial','Pelatihan','Lainnya'] as $cat): ?>
                                        <option value="<?php echo $cat; ?>"
                                            <?php echo ($event['category'] == $cat) ? 'selected' : ''; ?>>
                                            <?php echo $cat; ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control form-control-lg"
                                       ...
                                       value="<?php echo $event['registration_open']; ?>" required>
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control form-control-lg"
                                       ...
                                       value="<?php echo $event['registration_close']; ?>" required>
                            </div>
                        </div>
