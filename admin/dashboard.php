...
// Event terbaru (5) — sertakan jumlah pendaftar untuk status otomatis
$today         = date('Y-m-d');
        ...
        <div class="col-sm-6 col-xl-4">
            <div class="dashboard-stat-card">
                <div class="stat-content">
                    ...
                    <h3 class="fw-bold"><?php echo $active_registrations; ?></h3>
                </div>
                <div class="stat-icon">
                    ...
                    <ul class="list-group list-group-flush">
                        <?php if ($latest_events->num_rows > 0): ?>
                            <?php while($event = $latest_events->fetch_assoc()):
                                $remaining = $event['quota'] - (int)$event['registered'];
                            ?>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <?php elseif ($remaining <= 0): ?>
                                            <span class="badge bg-danger ms-2">Kuota Penuh</span>
